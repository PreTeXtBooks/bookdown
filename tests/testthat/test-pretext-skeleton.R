...
test_that("PreTeXt frontmatter mirrors the Rmd structure", {
  ...
  expect_match(frontmatter, "<xref ref=\"ch-intro\"/>", fixed = TRUE)
  expect_match(frontmatter, "<xref ref=\"rstudio-ide\"/>", fixed = TRUE)
  expect_match(frontmatter, "<xref ref=\"ch-usage\"/>", fixed = TRUE)
  expect_match(frontmatter, "<xref ref=\"ch-tools\"/>", fixed = TRUE)
...
test_that("PreTeXt introduction chapter mirrors the Rmd structure", {
  ...
  expect_match(intro, "<xref ref=\"ch-tools\"/>", fixed = TRUE)
  expect_match(intro, "<xref ref=\"ch-usage\"/>", fixed = TRUE)
